...
import pl.mvn.infra.model.Filter;
import pl.mvn.model.Car;
import pl.mvn.service.CarService;
...
import static pl.mvn.util.Utils.addDetailMessage;
    ...
    public void initDataModel() {
        cars = new LazyDataModel<Car>() {
            ...
            public List<Car> load(int first, int pageSize,
                ...
                pl.mvn.infra.model.SortOrder order = null;
                if (sortOrder != null) {
                    order = sortOrder.equals(SortOrder.ASCENDING) ? pl.mvn.infra.model.SortOrder.ASCENDING
                            : sortOrder.equals(SortOrder.DESCENDING) ? pl.mvn.infra.model.SortOrder.DESCENDING
                            : pl.mvn.infra.model.SortOrder.UNSORTED;
                }
